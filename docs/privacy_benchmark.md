...
The development definition now includes 50 cases and 103 labelled findings. It
...
A separate 10-case adversarial development layer combines participant identity
fields, workstation and network traces, short credentials, public and
participant contacts, structured free text, subject mappings, private
...
The standalone adversarial result is stored as
