...
**Current checkpoint:** 36 tests pass. Six public EEG BIDS examples were used for initial false-positive review, and four real Sleep-EDF files were checked without copying them into the repository. A clean package installation and the installed command were also checked.
